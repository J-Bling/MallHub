...
CREATE TABLE `pms_comment` (
  ...
  `member_icon` varchar(255) DEFAULT NULL COMMENT '会员头像URL',
  `product_name` varchar(255) DEFAULT NULL COMMENT '商品名称快照',
  `product_attribute` json DEFAULT NULL COMMENT '商品属性(JSON格式)',
  `star` int DEFAULT '0' COMMENT '用户评分(1-5星)',
  `content` varchar(500) DEFAULT NULL,
  `pics` varchar(1500) DEFAULT NULL,
  `replay_count` int DEFAULT '0' COMMENT '回复数量',
  `show_status` tinyint(1) DEFAULT '0' COMMENT '显示状态(0-待审核 1-已展示 2-已隐藏)',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_product` (`product_id`,`show_status`),
...
CREATE TABLE `pms_freight_template` (
  ...
  `charge_type` tinyint(1) NOT NULL COMMENT '计费方式(0-按件数 1-按重量)',
  `first_weight` decimal(10,2) DEFAULT NULL COMMENT '首重(kg)',
...
INSERT INTO `pms_product_attribute_category` VALUES (1,'服装-T恤',2,5),(2,'服装-裤装',2,4),(3,'手机数码-手机通讯',2,4),(4,'配件',0,0),(5,'居家',0,0),(6,'洗护',0,0),(10,'测试分类',0,0),(11,'服装-鞋帽',3,0),(12,'家用电器-电视',2,4),(13,'电脑办公-笔记本',2,3),(14,'家用电器-厨卫大电',1,3),(15,'电脑办公-硬盘',2,5);
...
--
-- Table structure for table `sms_flash_behavior`
--

DROP TABLE IF EXISTS `sms_flash_behavior`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sms_flash_behavior` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `member_id` bigint NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_member` (`member_id`),
  KEY `idx_session_product` (`session_id`,`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='秒杀用户行为表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sms_flash_behavior`
--

LOCK TABLES `sms_flash_behavior` WRITE;
/*!40000 ALTER TABLE `sms_flash_behavior` DISABLE KEYS */;
/*!40000 ALTER TABLE `sms_flash_behavior` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sms_flash_product_relation`
--

DROP TABLE IF EXISTS `sms_flash_product_relation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sms_flash_product_relation` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `promotion_id` bigint NOT NULL,
  `session_id` bigint NOT NULL,
  `product_id` bigint NOT NULL,
  `is_sku` tinyint(1) DEFAULT '0' COMMENT '0-商品维度 1-SKU维度',
  `flash_price` decimal(10,2) DEFAULT NULL COMMENT '商品维度价格（is_sku=0时生效）',
  `flash_stock` int DEFAULT NULL COMMENT '商品维度库存（is_sku=0时生效）',
  `flash_limit` int NOT NULL DEFAULT '1' COMMENT '商品维度限购',
  `original_price` decimal(10,2) DEFAULT NULL COMMENT '商品维度原价',
  `sort` int NOT NULL DEFAULT '0' COMMENT '排序权重',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_promotion_session` (`promotion_id`,`session_id`),
  KEY `idx_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='秒杀商品关联表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sms_flash_product_relation`
--

LOCK TABLES `sms_flash_product_relation` WRITE;
/*!40000 ALTER TABLE `sms_flash_product_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `sms_flash_product_relation` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `sms_flash_session`
--

DROP TABLE IF EXISTS `sms_flash_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `sms_flash_session`
--
...
--
-- Table structure for table `sms_flash_sku_relation`
--

DROP TABLE IF EXISTS `sms_flash_sku_relation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sms_flash_sku_relation` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `product_relation_id` bigint NOT NULL COMMENT '关联主表ID',
  `product_id` bigint NOT NULL,
  `sku_id` bigint NOT NULL,
  `sku_code` varchar(200) NOT NULL COMMENT 'SKU编码',
  `flash_price` decimal(10,2) NOT NULL COMMENT '秒杀价',
  `flash_stock` int NOT NULL DEFAULT '0' COMMENT 'SKU库存',
  `flash_limit` int NOT NULL DEFAULT '1' COMMENT 'SKU维度限购',
  `original_price` decimal(10,2) DEFAULT NULL COMMENT '原价',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_sku_relation` (`sku_id`,`product_relation_id`),
  KEY `idx_relation` (`product_relation_id`),
  KEY `idx_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='秒杀SKU关联表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sms_flash_sku_relation`
--

LOCK TABLES `sms_flash_sku_relation` WRITE;
/*!40000 ALTER TABLE `sms_flash_sku_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `sms_flash_sku_relation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sms_flash_stock_flow`
--

DROP TABLE IF EXISTS `sms_flash_stock_flow`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sms_flash_stock_flow` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `product_relation_id` bigint NOT NULL COMMENT '秒杀商品关联ID',
  `session_id` bigint NOT NULL COMMENT '场次ID',
  `product_id` bigint NOT NULL COMMENT '商品id',
  `sku_id` bigint DEFAULT NULL COMMENT 'NULL表示商品维度操作',
  `change_amount` int NOT NULL COMMENT '库存变化量',
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_product_relation` (`product_relation_id`),
  KEY `idx_order` (`order_id`),
  KEY `idx_session` (`session_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='秒杀库存流水表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sms_flash_stock_flow`
--

LOCK TABLES `sms_flash_stock_flow` WRITE;
/*!40000 ALTER TABLE `sms_flash_stock_flow` DISABLE KEYS */;
/*!40000 ALTER TABLE `sms_flash_stock_flow` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ums_member` VALUES (1,4,'test','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','test','18061581849',1,'2018-08-02 10:35:44','https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_03.png',1,'2009-06-01','上海','学生','test',NULL,3900,1000,NULL,NULL,NULL),(3,4,'windy','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','windy','18061581848',1,'2018-08-03 16:46:38',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,4,'zhengsan','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','zhengsan','18061581847',1,'2018-11-12 14:12:04',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,4,'lisi','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','lisi','18061581841',1,'2018-11-12 14:12:38',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,4,'wangwu','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','wangwu','18061581842',1,'2018-11-12 14:13:09',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,4,'lion','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','lion','18061581845',1,'2018-11-12 14:21:39',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,4,'shari','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','shari','18061581844',1,'2018-11-12 14:22:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,4,'aewen','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','aewen','18061581843',1,'2018-11-12 14:22:55',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(10,4,'guest','$2a$10$WQiD4RzEs1iJVWU.2HVu8OdSlExJHWKmwndaw3SUfMyqfKZmXe1vq',NULL,'18911111111',1,'2020-03-14 14:52:18',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(11,4,'member','$2a$10$Q08uzqvtPj61NnpYQZsVvOnyilJ3AU4VdngAcJFGvPhEeqhhC.hhS','member','18961511111',1,'2023-05-11 15:22:38','https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_02.png',1,'2009-06-01','上海','学生','member',NULL,5000,1000,NULL,NULL,NULL);
...
INSERT INTO `ums_member_receive_address` VALUES (1,1,'大梨','18033441849',0,'518000','广东省','深圳市','南山区','科兴科学园'),(3,1,'大梨','18033441849',0,'518000','广东省','深圳市','福田区','清水河街道'),(4,1,'大梨','18033441849',1,'518000','广东省','深圳市','福田区','东晓街道'),(5,11,'小李','18961511111',1,'518000','广东省','深圳市','福田区','东晓街道'),(6,11,'小李','18961511111',NULL,'518000','广东省','深圳市','福田区','清水河街道');
