...
public class PmsProductController {
    ...
    @ResponseBody
    public ResponseResult<Integer> updateVerifyStatus(@RequestParam("ids") List<Long> ids,
    ...
    @ResponseBody
    public ResponseResult<Integer> updatePublishStatus(@RequestParam("ids") List<Long> ids,
    ...
    @ResponseBody
    public ResponseResult<Integer> updateRecommendStatus(@RequestParam("ids") List<Long> ids,
    ...
    @ResponseBody
    public ResponseResult<Integer> updateNewStatus(@RequestParam("ids") List<Long> ids,
    ...
    @ResponseBody
    public ResponseResult<Integer>  updateDeleteStatus(@RequestParam("ids") List<Long> ids,
