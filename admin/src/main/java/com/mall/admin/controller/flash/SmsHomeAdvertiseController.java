...
public class SmsHomeAdvertiseController {
    ...
    @ResponseBody
    public ResponseResult create(@RequestBody SmsHomeAdvertise advertise) {
    ...
    @ResponseBody
    public ResponseResult update(@PathVariable Long id, @RequestBody SmsHomeAdvertise advertise) {
