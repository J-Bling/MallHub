...
import com.mall.admin.service.flash.SmsHomeAdvertiseService;
...
public class SmsHomeAdvertiseController {
    ...
    @ApiOperation("添加广告")
    @PostMapping("/create")
    public ResponseResult<Integer> create(@RequestBody SmsHomeAdvertise advertise) {
    ...
    @ApiOperation("获取广告详情")
    @GetMapping("/{id}")
    public ResponseResult<SmsHomeAdvertise> getItem(@PathVariable Long id) {
        SmsHomeAdvertise advertise = advertiseService.getItem(id);
        return ResponseResult.success(advertise);
    }

    @ApiOperation("修改广告")
    @PostMapping("/update/{id}")
    public ResponseResult<Integer> update(@PathVariable Long id, @RequestBody SmsHomeAdvertise advertise) {
    ...
    @ApiOperation("分页查询广告")
    @GetMapping("/list")
    public ResponseResult<ResponsePage<SmsHomeAdvertise>> list(@RequestParam(value = "name", required = false) String name,
        ...
        return ResponseResult.success(ResponsePage.getPage(advertiseList));
    }
}
