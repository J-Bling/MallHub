...
public class SmsCouponController {
    ...
    @ApiOperation("添加优惠券")
    @PostMapping("/create")
    public ResponseResult<Integer> add(@RequestBody SmsCouponParam couponParam) {
    ...
    public ResponseResult<Integer> update(@PathVariable Long id,@RequestBody SmsCouponParam couponParam) {
