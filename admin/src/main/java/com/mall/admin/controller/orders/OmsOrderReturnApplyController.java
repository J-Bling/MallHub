...
public class OmsOrderReturnApplyController {
    ...
    @GetMapping("/{id}")
    public ResponseResult<OmsOrderReturnApplyResult> getItem(@PathVariable Long id) {
    ...
    public ResponseResult<Integer> updateStatus(@PathVariable Long id, @RequestBody OmsUpdateStatusParam statusParam) {
